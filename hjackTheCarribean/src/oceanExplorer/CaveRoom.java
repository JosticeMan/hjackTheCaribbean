...
public class CaveRoom {
	...
	public static void setUpCaves() {
		...
		//end
		//Andrew room
		CaveExplorer.caves[0][4]=new StevenRoom("This is Steven's");
		CaveExplorer.caves[0][3].setConnection(EAST,CaveExplorer.caves[0][2],new Door());
		CaveExplorer.caves[0][5].setConnection(SOUTH,CaveExplorer.caves[1][2],new Door());
